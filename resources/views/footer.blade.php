<footer class="text-center text-lg-start bg-white text-muted">
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-1 w-25">
                    ...
                    <p class="px-3"><img class="footer-images"src="/images/home.png" alt="">Sifal, Kathmandu
                    </p>
                    <p class="px-3"><img class="footer-images"src="/images/email.png"
                            alt="">contact.techware@gmail.com</p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
        © 2021 Copyright:
        <a class="text-reset fw-bold" href="/">TechWare.com</a>
    </div>
</footer>
