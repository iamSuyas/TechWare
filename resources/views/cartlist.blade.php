    ...
    <div class="custom-product d-flex justify-content-center">
        <div class="col-sm-10">
                            ...
                            <div class="col-sm-8 ">
                                ...
                                <div class="d-flex justify-self-start align-items-center">
                                    <a class="btn btn-sm btn-dark"
                                        onclick="decrementCount({{ $product->cartId }}, {{ $product->cartCount }})">-</a>
                                    <input type="number" id="count_{{ $product->cartId }}"
                                        name="cart_count_{{ $product->cartId }}" value="{{ $product->cartCount }}"
                                        class="form-control mx-1 quantity-button no-spinners" min="1">
                                    <a class="btn btn-sm btn-dark"
                                        onclick="incrementCount({{ $product->cartId }}, {{ $product->cartCount }})">+</a>
                                </div>
                            </div>
            ...
            <div class="order w-100 d-flex justify-content-end">
                <button type="submit" form="updateForm" class="btn btn-dark ">Order Now</button>
            </div>
