               ...
               <div class="col-sm-8">
                 <div class="fw-medium">
                   ...
                   <div class="mb-3">
                      ...
                      <option value="Order Placed" @if($data->status === 'Order Placed') selected @endif>Order Placed</option>
                <option value="Package in logistics" @if($data->status === 'Package in logistics') selected @endif>Package in logistics</option>
                <option value="Package shipped" @if($data->status === 'Package shipped') selected @endif>Package shipped</option>
                <option value="Out for delivery" @if($data->status === 'Out for delivery') selected @endif>Out for delivery</option>
